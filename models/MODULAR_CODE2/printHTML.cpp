...
void createHTML( string ResultPath, vector <TOKENIZER> Folder_Files, vector <MATCHER> ALL_MATCHES )
{
    ...
    for(unsigned long int All_MATCHES_INDEX = 0; All_MATCHES_INDEX < ALL_MATCHES.size() ; All_MATCHES_INDEX++ )
    {
        ...
        unordered_map < string, unsigned long int > line_file1 = ALL_MATCHES[All_MATCHES_INDEX].getline_file1();
        ...
        unordered_map < string, unsigned long int > line_file2 = ALL_MATCHES[All_MATCHES_INDEX].getline_file2();
        ...
        outStream << "<!DOCTYPE html>\n"
                  ...
                  << "</head>\n"
                  << "<hr>"
                  << "<center> <h3 style=\"font-family:verdana\"><u> RESULTS " << "</u></h3> </center>"
                  << "\n"
                  << "<center> <h4 style=\"font-family:verdana\"> "
                  << file1_name << " - " << "<b><u>" << "<font color=\"red\">" << percent_1 << "%" << "</font>" << "</b></u>"
                  << " & "
                  << file2_name << " - " << "<b><u>" << "<font color=\"red\">" << percent_2 << "%" << "</font>" << "</b></u>"
                  << "</h4> </center>"
                  << "<hr>\n"
                  << "<iframe height=\"500\" width=\"660\" src=\"match" +  to_string(All_MATCHES_INDEX) + "-0" + ".html" << " \" name = \"iframe_1\" >\n</iframe>\n"
                  << "<iframe height=\"500\" width=\"660\" src=\"match" +  to_string(All_MATCHES_INDEX) + "-1" + ".html" << " \" name = \"iframe_2\" >\n</iframe>\n"
                  << "</body>\n"
                  << "</html>";
        outStream.close();
    }
